...
router.get('/', (req, res) => {
  const sql = 'SELECT id, name, surname, email, profile_pic, created_at FROM users';
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    const query = 'INSERT INTO users (name, surname, email, password_hash, created_at) VALUES (?, ?, ?, ?, NOW())';
